...
function ensureEnv({ file, example, defaults = {}, generated = {} }) {
  ...
  for (const [key, makeValue] of Object.entries(generated)) {
    ...
    if (!current || current.includes("change-me") || current.includes("replace-with")) {
...
ensureEnv({
  ...
  example: ".env.example",
  defaults: {
    LOCAL_SUPERADMIN_EMAIL: "admin@makemoneyordie.local",
...
ensureEnv({
  ...
  defaults: {
    ...
    DATABASE_URL: "postgres://makemoneyordie:makemoneyordie@localhost:5432/makemoneyordie",
